...
namespace SlippageBackend.Controllers.v1.Slippage
{
    ...
    {
        [HttpGet]
        public async  Task<IActionResult> CalculateSlippage([FromQuery] decimal amountIn, [FromQuery] decimal gasPrice , [FromQuery] bool isBuy , [FromQuery] decimal lpFeeTier)
        {
            var x = await aggregatorService.GetLiquidity();
